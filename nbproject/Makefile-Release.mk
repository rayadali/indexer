...
${OBJECTDIR}/_ext/198708989/sorted-list.o: ../../../Desktop/uni\ work/cs\ 214/sorted\ list/sorted-list.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/198708989/sorted-list.o ../../../Desktop/uni\ work/cs\ 214/sorted\ list/sorted-list.c
...
${OBJECTDIR}/hashWordCount.o: hashWordCount.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hashWordCount.o hashWordCount.c

${OBJECTDIR}/hashimplementation.o: hashimplementation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hashimplementation.o hashimplementation.c

${OBJECTDIR}/indexer.o: indexer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/indexer.o indexer.c

${OBJECTDIR}/indexer2.o: indexer2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/indexer2.o indexer2.c

${OBJECTDIR}/tokenizeran.o: tokenizeran.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tokenizeran.o tokenizeran.c
